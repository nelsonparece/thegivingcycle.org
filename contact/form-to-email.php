...
$email_recipients = "contactus@thegivingcycle.org";//<<=== enter your email address here
...
$email_subject = "Contact email submission from thegivingcycle.org";
...
$email_from = 'contactus@thegivingcycle.org'; /*From address for the emails*/
//$thank_you_url = 'thank-you.html';/*URL to redirect to, after successful form submission*/
$thank_you_url = 'http://thegivingcycle.org/index.php';/*URL to redirect to, after successful form submission*/
